...
```
OpenROAD-flow-public/tools/OpenROAD/Dockerfile
OpenROAD-flow-public/tools/yosys/Dockerfile
OpenROAD-flow-public/tools/TritonRoute/Dockerfile
```
...
## License
The OpenROAD-flow-public repository (build and run scripts) has a BSD 3-Clause License.
The flow relies on several tools, platforms and designs that each have their own
licenses:
- Find the tool license at: `OpenROAD-flow-public/tools/{tool}/` or
`OpenROAD-flow-public/tools/OpenROAD/src/{tool}/`
- Find the platform license at: `OpenROAD-flow-public/flow/platforms/{platform}/`
- Find the design license at: `OpenROAD-flow-public/flow/designs/src/{design}/`
